      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 pb-10">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            <h4 className="text-2xl font-bold tracking-tight mb-4">ThermoConfort</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold text-white/40 uppercase tracking-wider mb-4">Services</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold text-white/40 uppercase tracking-wider mb-4">Contact</h4>
            <ul className="space-y-3">
              <li className="text-sm text-white/60">
                <a href="tel:+33102030405" className="hover:text-white transition-colors">01 02 03 04 05</a>
              </li>
              <li className="text-sm text-white/60">
                <a href="mailto:Bisignano.julien@gmail.com" className="hover:text-white transition-colors">Bisignano.julien@gmail.com</a>
              </li>
              <li className="text-sm text-white/60">
                57 Boulevard de la Republique<br/>78400 Chatou
              </li>
            </ul>
          </div>
        </div>
